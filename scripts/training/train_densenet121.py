# Baseline: DenseNet-121 with frozen pretrained backbone, only final classifier trained.
...
MODEL_DIR   = "/content/models/densenet121"
...
for epoch in range(1, NUM_EPOCHS + 1):
    ...
    if val_acc > best_val_acc:
        ...
        shutil.copy(BEST_MODEL,
                    f"{DRIVE_DIR}/models/best_model_densenet121.pth")
...
results = {
    "model":                  "DenseNet-121 Baseline (frozen backbone)",
...
metrics_path = os.path.join(METRICS_DIR, "densenet121_results.json")
...
plt.tight_layout()
acc_plot = os.path.join(PLOTS_DIR, "densenet121_accuracy.png")
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
loss_plot = os.path.join(PLOTS_DIR, "densenet121_loss.png")
...
plt.title("DenseNet-121 — Confusion Matrix (Test Set)")
plt.xlabel("Predicted")
plt.ylabel("True")
plt.tight_layout()
cm_plot = os.path.join(PLOTS_DIR, "densenet121_confusion.png")
...
sep = "=" * 55
print(sep)
print("  DENSENET-121 — FINAL RESULTS")
print(sep)
...
shutil.copy(metrics_path,
            f"{DRIVE_DIR}/results/densenet121_results.json")
for plot in ["densenet121_accuracy.png",
             "densenet121_loss.png",
             "densenet121_confusion.png"]:
